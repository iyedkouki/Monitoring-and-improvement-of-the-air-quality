...
public class HumidityYear extends AppCompatActivity {
    RecyclerView recyclerView;
    ArrayList<YearClass> yearClasses;
    HumidityYearAdapter humidityYearAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_humidity_year);
        recyclerView=findViewById(R.id.recycler);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(HumidityYear.this));
        lineChart=findViewById(R.id.lineChart);
        retourne=findViewById(R.id.returne_);
        retourne.setOnClickListener(view -> startActivity(new Intent(HumidityYear.this, Humidity_main.class)));
        db= FirebaseFirestore.getInstance();
        yearClasses =  new ArrayList<YearClass>();
        humidityYearAdapter =new HumidityYearAdapter(HumidityYear.this, yearClasses);
        recyclerView.setAdapter(humidityYearAdapter);
        EvenChangelister();


        buttond=findViewById(R.id.button);
        buttond.setOnClickListener(view -> startActivity(new Intent(HumidityYear.this, Humidity_day.class)));
        buttonm=findViewById(R.id.buttonm);
        buttonm.setOnClickListener(view -> startActivity(new Intent(HumidityYear.this, HumidityMonth.class)));
    ...
    private void updateGraphWithRecyclerViewData() {
        ...
        for (int i = 0, j = yearClasses.size() - 1; i < yearClasses.size(); i++, j--) {
            ...
            // Use the index as X-axis value (for simplicity) and PressureMax as Y-axis value
            entries.add(new Entry(i, Float.parseFloat(yearClass.gethuma())));
