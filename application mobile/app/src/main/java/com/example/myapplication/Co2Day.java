...
public class Co2Day extends AppCompatActivity {
    RecyclerView recyclerView;
    ArrayList<dayclass> dayclasses;
    Co2DayAdapter dayAdapter;
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_co2_day);
        recyclerView=findViewById(R.id.recycler);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(Co2Day.this));
        lineChart=findViewById(R.id.lineChart);
        retourne=findViewById(R.id.returne_);
        retourne.setOnClickListener(view -> startActivity(new Intent(Co2Day.this, CO2main.class)));
        db= FirebaseFirestore.getInstance();
        dayclasses=  new ArrayList<dayclass>();
        dayAdapter=new Co2DayAdapter(Co2Day.this,dayclasses);
        recyclerView.setAdapter(dayAdapter);
        EvenChangelister();

        buttonm=findViewById(R.id.buttonm);
        buttonm.setOnClickListener(view -> startActivity(new Intent(Co2Day.this, Co2Month.class)));
        buttony=findViewById(R.id.buttony);
        buttony.setOnClickListener(view -> startActivity(new Intent(Co2Day.this, Co2Year.class)));
    ...
    private void updateGraphWithRecyclerViewData() {
        ...
        for (int i = 0, j = dayclasses.size() - 1; i < dayclasses.size(); i++, j--) {
            ...
            // Use the index as X-axis value (for simplicity) and PressureMax as Y-axis value
            entries.add(new Entry(i, Float.parseFloat(dayclass.getCo2j())));
