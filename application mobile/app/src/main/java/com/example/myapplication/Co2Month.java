...
public class Co2Month extends AppCompatActivity {
    RecyclerView recyclerView;
    ArrayList<MonthClass> monthClasses;
    Co2MonthAdapter co2MonthAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_co2_month);

        recyclerView=findViewById(R.id.recycler);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(Co2Month.this));
        lineChart=findViewById(R.id.lineChart);
        retourne=findViewById(R.id.returne_);
        retourne.setOnClickListener(view -> startActivity(new Intent(Co2Month.this, CO2main.class)));
        db= FirebaseFirestore.getInstance();
        monthClasses=  new ArrayList<MonthClass>();
        co2MonthAdapter =new Co2MonthAdapter(Co2Month.this,monthClasses);
        recyclerView.setAdapter(co2MonthAdapter);
        EvenChangelister();

        buttond=findViewById(R.id.button);
        buttond.setOnClickListener(view -> startActivity(new Intent(Co2Month.this, Co2Day.class)));
        buttony=findViewById(R.id.buttony);
        buttony.setOnClickListener(view -> startActivity(new Intent(Co2Month.this, Co2Year.class)));
        ...
        db.collection("theSensorsmonth").addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                for(DocumentChange dc: value.getDocumentChanges()){
                    ...
                    co2MonthAdapter.notifyDataSetChanged();
    ...
    private void updateGraphWithRecyclerViewData() {
        ...
        for (int i = 0, j = monthClasses.size() - 1; i < monthClasses.size(); i++, j--) {
            ...
            // Use the index as X-axis value (for simplicity) and PressureMax as Y-axis value
            entries.add(new Entry(i, Float.parseFloat(monthClass.getCo2m())));
