...
public class PressureMonth extends AppCompatActivity {
    RecyclerView recyclerView;
    ArrayList<MonthClass> monthClasses;
    PressureMonthAdapter humidityMonthAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pressure_month);

        recyclerView=findViewById(R.id.recycler);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(PressureMonth.this));
        lineChart=findViewById(R.id.lineChart);
        retourne=findViewById(R.id.returne_);
        retourne.setOnClickListener(view -> startActivity(new Intent(PressureMonth.this, Pressure_main.class)));
        db= FirebaseFirestore.getInstance();
        monthClasses=  new ArrayList<MonthClass>();
        humidityMonthAdapter=new PressureMonthAdapter(PressureMonth.this,monthClasses);
        recyclerView.setAdapter(humidityMonthAdapter);
        EvenChangelister();
        buttond=findViewById(R.id.button);
        buttond.setOnClickListener(view -> startActivity(new Intent(PressureMonth.this, PressureDay.class)));
        buttony=findViewById(R.id.buttony);
        buttony.setOnClickListener(view -> startActivity(new Intent(PressureMonth.this, PressureYear.class)));
    }
    ...
    private void updateGraphWithRecyclerViewData() {
        ...
        for (int i = 0, j = monthClasses.size() - 1; i < monthClasses.size(); i++, j--) {
            ...
            // Use the index as X-axis value (for simplicity) and PressureMax as Y-axis value
            entries.add(new Entry(i, Float.parseFloat(monthClass.getprem())));
