...
public class Humidity_day extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_humidity_day);
        recyclerView=findViewById(R.id.recycler);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(Humidity_day.this));
        lineChart=findViewById(R.id.lineChart);
        retourne=findViewById(R.id.returne_);
        retourne.setOnClickListener(view -> startActivity(new Intent(Humidity_day.this, Humidity_main.class)));
        db= FirebaseFirestore.getInstance();
        dayclasses=  new ArrayList<dayclass>();
        dayAdapter=new dayAdapter(Humidity_day.this,dayclasses);
        recyclerView.setAdapter(dayAdapter);
        EvenChangelister();

        buttonm=findViewById(R.id.buttonm);
        buttonm.setOnClickListener(view -> startActivity(new Intent(Humidity_day.this, HumidityMonth.class)));
        buttony=findViewById(R.id.buttony);
        buttony.setOnClickListener(view -> startActivity(new Intent(Humidity_day.this, HumidityYear.class)));
    ...
    private void updateGraphWithRecyclerViewData() {
        ...
        for (int i = 0, j = dayclasses.size() - 1; i < dayclasses.size(); i++, j--) {
            ...
            // Use the index as X-axis value (for simplicity) and PressureMax as Y-axis value
            entries.add(new Entry(i, Float.parseFloat(dayclass.gethumj())));
