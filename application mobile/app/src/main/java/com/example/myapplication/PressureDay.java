...
public class PressureDay extends AppCompatActivity {
    RecyclerView recyclerView;
    ArrayList<dayclass> dayclasses;
    PressureDayAdapter dayAdapter;
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pressure_day);
        recyclerView=findViewById(R.id.recycler);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(PressureDay.this));
        lineChart=findViewById(R.id.lineChart);
        retourne=findViewById(R.id.returne_);
        retourne.setOnClickListener(view -> startActivity(new Intent(PressureDay.this, Pressure_main.class)));
        db= FirebaseFirestore.getInstance();
        dayclasses=  new ArrayList<dayclass>();
        dayAdapter=new PressureDayAdapter(PressureDay.this,dayclasses);
        recyclerView.setAdapter(dayAdapter);
        EvenChangelister();
        buttonm=findViewById(R.id.buttonm);
        buttonm.setOnClickListener(view -> startActivity(new Intent(PressureDay.this, PressureMonth.class)));
        buttony=findViewById(R.id.buttony);
        buttony.setOnClickListener(view -> startActivity(new Intent(PressureDay.this, PressureYear.class)));
    ...
    private void updateGraphWithRecyclerViewData() {
        ...
        for (int i = 0, j = dayclasses.size() - 1; i < dayclasses.size(); i++, j--) {
            ...
            // Use the index as X-axis value (for simplicity) and PressureMax as Y-axis value
            entries.add(new Entry(i, Float.parseFloat(dayclass.getprej())));
